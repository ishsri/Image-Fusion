...
for epoch in range(EPOCHS):    
    ...
    with torch.no_grad():
        for idx in range(0, batch_idxs_val):
            ...
            if epoch % 1 == 0:
                ...
                torchvision.utils.save_image(images_concat, '/home/h3/issr292b/image_fusion/val_samples/ssim_0.1/epoch_{}.png'.format(epoch))
    ...
    if epoch == 100:    
        ...
        torch.save(
            ...
            os.path.join(path, "model_r2_0.1.pt"))
