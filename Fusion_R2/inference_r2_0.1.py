...
mod = torch.load(r"/home/h3/issr292b/image_fusion/epoch/model_r2_0.1.pt")
...
for i in range(0, total_val_images):
    with torch.no_grad():
        ...
        torchvision.utils.save_image(weight_map_val, '/home/h3/issr292b/image_fusion/inference_r2/0.1/weight_map/count_{}.png'.format(i))