...
hf = h5py.File("C:\Users\ishan\Desktop\Image Fusion\fusion_r2_training_data.h5", 'r')
...
for epoch in range(EPOCHS):    
    ...
    for idx in range(0, batch_idxs):
        input_ = train_data_tensor[idx*batch_size : (idx+1)*batch_size,0:1,:,:].to(device)
        weight_map = model(input_)
        #fused = weight_map*input_[:,0:1,:,:] + (1-weight_map)*input_[:,1:2,:,:]

        
        path_im = f"/home/h3/issr292b/image_fusion/train_samples/ssim_0.49/"
        path_fused = f"/home/h3/issr292b/image_fusion/train_samples_fused/ssim_0.49/"
        ...
        fused_save = torchvision.utils.make_grid(weight_map, nrow = int(weight_map.shape[0] ** 0.5), padding=2, pad_value=255)
        torchvision.utils.save_image(images_concat, '/home/h3/issr292b/image_fusion/train_samples/ssim_0.49/count_{}.png'.format(count))
        torchvision.utils.save_image(fused_save, '/home/h3/issr292b/image_fusion/train_samples_fused/ssim_0.49/count_{}.png'.format(count))
    ...
    with torch.no_grad():
        for idx in range(0, batch_idxs_val):
            ...
            if epoch % 1 == 0:
                path_im = f"/home/h3/issr292b/image_fusion/val_samples/ssim_0.49/"
                path_weight_val = f"/home/h3/issr292b/image_fusion/val_samples_fused/ssim_0.49/"
                os.makedirs(path_im, exist_ok=True)
                ...
                torchvision.utils.save_image(weight_val, '/home/h3/issr292b/image_fusion/val_samples/ssim_0.49/epoch_{}.png'.format(epoch))
                torchvision.utils.save_image(images_concat, '/home/h3/issr292b/image_fusion/val_samples_fused/ssim_0.49/epoch_{}.png'.format(epoch))
    ...
    if epoch == 50:    
        ...
        torch.save(
            ...
            os.path.join(path, "model_0.49.pt"))
