...
for epoch in range(EPOCHS):    
    ...
    for idx in range(0, batch_idxs):
        ...
        path_im = f"/home/h3/issr292b/image_fusion/train_samples/en-de/ssim_0.49/"
        path_fused = f"/home/h3/issr292b/image_fusion/train_samples_fused/en-de/ssim_0.49/"
        ...
        if count % 10 == 0:
            torchvision.utils.save_image(images_concat, '/home/h3/issr292b/image_fusion/train_samples/en-de/ssim_0.49/count_{}.png'.format(count))
            torchvision.utils.save_image(fused_save, '/home/h3/issr292b/image_fusion/train_samples_fused/en-de/ssim_0.49/count_{}.png'.format(count))
    ...
    with torch.no_grad():
        for idx in range(0, batch_idxs_val):
            ...
            if epoch % 1 == 0:
                path_im = f"/home/h3/issr292b/image_fusion/val_samples/en-de/ssim_0.49/"
                path_weight_val = f"/home/h3/issr292b/image_fusion/val_samples_fused/en-de/ssim_0.49/"
                os.makedirs(path_im, exist_ok=True)
                ...
                torchvision.utils.save_image(weight_val, '/home/h3/issr292b/image_fusion/val_samples/en-de/ssim_0.49/epoch_{}.png'.format(epoch))
                torchvision.utils.save_image(images_concat, '/home/h3/issr292b/image_fusion/val_samples_fused/en-de/ssim_0.49/epoch_{}.png'.format(epoch))
